...
(function () {
  function buildProjectPreviewCard(project) {
    return [
      ...
      '    <img src="' + project.image + '" alt="' + project.title + ' preview image">',
      '  </div>',
  ...
  function buildJournalCard(journal) {
    return [
      ...
      '    <img src="' + journal.image + '" alt="' + journal.title + ' cover image">',
      '  </div>',
      '  <div class="stack">',
  ...
  function buildRoleCard(role) {
    return [
      ...
      '    <img src="' + role.image + '" alt="' + role.name + ' portrait">',
      '  </div>',
      '  <div class="stack">',
      '    <h3>' + role.name + '</h3>',
  ...
  function buildProjectGridCard(project) {
    ...
    return [
      ...
      '    <!-- EDIT ME: replace src with your project image -->',
      '    <img src="' + project.image + '" alt="' + project.title + ' cover image">',
      '  </div>',
